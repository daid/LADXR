...
Location().add(ShopBombs()).connect(start, COUNT("RUPEES", 10))
Location().add(ShopShovel()).connect(start, COUNT("RUPEES", 200))
#DISABLED FOR TESTING: Location().add(ShopBow()).connect(start, COUNT("RUPEES", 900))
#TODO: dream hut
...
#DISABLED FOR TESTING: Location().add(Chest(0x2B3)).connect(forest, AND("POWER_BRACELET", "HOOKSHOT"))  # hookshot cave
