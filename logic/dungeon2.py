...
class Dungeon2:
    def __init__(self, options, world_setup, r):
        ...
        Location(dungeon=2).add(DungeonChest(0x137)).connect(dungeon2_r2, AND(KEY2, FOUND(KEY2, 5), r.enemy_requirements["MASKED_MIMIC_GORIYA"]), id="c0")  # compass chest
        ...
        dungeon2_pre_stairs_boss = Location("D2 Before Boss Stairs", dungeon=2).connect(dungeon2_r6, AND(r.enemy_requirements["ZOL"], OR(r.enemy_requirements["POLS_VOICE"], POWER_BRACELET), POWER_BRACELET, KEY2, FOUND(KEY2, 5)), id="cf")
