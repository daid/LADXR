...
class Dungeon2:
    def __init__(self):
        ...
        Location(2).add(DungeonChest(0x12E)).connect(dungeon2_l2, AND(attack_powder, OR(FEATHER, HOOKSHOT)))  # map chest
        ...
        dungeon2_r3 = Location(2).add(DungeonChest(0x138)).connect(dungeon2_r2, attack_hookshot)  # first chest with key
        ...
        dungeon2_r5 = Location(2).add(DungeonChest(0x126)).add(DungeonChest(0x121)).connect(dungeon2_r4, AND(KEY2, attack_hookshot) # post hinox
        Location(2).add(DungeonChest(0x120)).connect(dungeon2_r5, AND(KEY2, OR(fire, BOW)))  # bracelet chest
