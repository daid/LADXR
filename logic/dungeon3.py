...
class Dungeon3:
    def __init__(self, options, world_setup, r):
        ...
        if options.logic == 'hell':
            ...
            before_c_passage.connect(after_c_passage, r.bracelet_bounce_2d_spikepit, back=OR(r.bracelet_bounce_2d_spikepit, r.boots_bonk_2d_hell)) # dash left from piranha, bonk and climb the wall. boots can drop thwomp in reverse. OR bracelet to get damage boost from 2d spikes
            ...
            if options.overworld != 'alttp' and options.overworld != 'dungeondive':
                before_c_passage.connect(after_c_passage, OR(r.boots_bonk_2d_spikepit, r.toadstool_bounce_2d_spikepit), back=r.toadstool_bounce_2d_spikepit) # boots bonk with medicine invulnerability. OR toadstool to get damage boost from 2d spikes. holding the "A" button while airborne in sidescroller makes you lighter
