...
class Dungeon3:
    def __init__(self, options, world_setup, r):
        ...
        if options.logic == 'glitched' or options.logic == 'hell':
            ...
            dungeon3_post_dodongo_chest.connect(area_right, AND(options.nagmessages, r.super_jump_feather, FOUND(KEY3, 6))) # superjump from keyblock path. use 2 keys to open enough blocks
