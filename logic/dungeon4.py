...
class Dungeon4:
    def __init__(self, options, world_setup, r):
        ...
        if options.logic == 'hell':
            ...
            #TODO: outside_b_passage_shallows.connect(before_miniboss_chest8, AND(r.jesus_buffer, TOADSTOOL)) # [wait for permanent toadstool patch] boots bonk to upper right of chest, buffer down, then hold left+toadstool to land on shallow water
