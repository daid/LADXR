...
class Dungeon5:
    def __init__(self, options):
        ...
        before_boss = Location(5).connect(after_stalfos, AND(FEATHER, HOOKSHOT)) # at boss door
        before_boss.connect(after_keyblock_boss, HOOKSHOT) 
        ...
        if options.logic == 'hard' or options.logic == 'glitched':
            ...
            before_boss.connect(after_stalfos, AND(FEATHER, PEGASUS_BOOTS)) # cross pits room from bottom left to top left with boots jump
