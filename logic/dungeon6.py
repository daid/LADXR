...
class Dungeon6:
    def __init__(self, options, world_setup, r, *, raft_game_chest=True):
        ...
        boss = Location("D6 Boss Rewards", dungeon=6).add(HeartContainer(0x1BC), Instrument(0x1b5)) # heart container, instrument
        ...
        boss_room.connect(boss, r.boss_requirements[world_setup.boss_mapping[5]]) # Boss Room <--> Boss Rewards
