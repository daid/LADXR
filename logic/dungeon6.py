...
class Dungeon6:
    def __init__(self, options, world_setup, r, *, raft_game_chest=True):
        ...
        if options.logic == 'hell':
            ...
            center_1.connect(miniboss, AND(r.damage_boost_special, COUNT(POWER_BRACELET, 2))) # use a double damage boost from the sparks to get across (first one is free, second one needs to buffer while in midair for spark to get close enough)
