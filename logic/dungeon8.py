...
class Dungeon8:
    def __init__(self, options, world_setup, r):
        ...
        Location(8).add(DroppedKey(0x24C)).connect(entrance_left, r.attack_hookshot_no_bomb) # vire drop key
        ...
        boss = Location(8).add(HeartContainer(0x234), Instrument(0x230)).connect(entrance_up, AND(NIGHTMARE_KEY8, FEATHER, r.boss_requirements[world_setup.boss_mapping[7]]))
