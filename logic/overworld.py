...
class World:
    def __init__(self, options, world_setup, r):
        ...
        kanalet_chain_trooper = Location().add(GoldLeaf(0x2C6)).connect(castle_top_inside, AND(POWER_BRACELET, r.attack_hookshot))  # in the castle, spinning spikeball enemy
