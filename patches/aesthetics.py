...
def reduceMessageLengths(rom, rnd):
    ...
    rom.texts[0x01] = formatText(rnd.choice([
        ...
        "Shoot, I WAS going to steal your kidneys while you were alive.",
        ...
        "skibidi toilet\n...\nYes, that joke WILL age well, palex.",
        "I have returned from the dead with copyright-compliant music!",
        ...
        "What a wake up!  I thouught you'd never Marin!  You were feeling a bit woozy and Zelda... What? Koholint?  No, my name's relief!  You must still be tossing.  You are on turning Island!",
