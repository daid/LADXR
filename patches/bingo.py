...
BINGO_GOALS = [
    ...
    Goal("Find 5 Secret Seashells", checkForSeashellsCode(5), ITEM_TILES[SEASHELL], group="seashells"),
    Goal("Find 10 Secret Seashells", checkForSeashellsCode(10), ITEM_TILES[SEASHELL], group="seashells"),
    Goal("Find 15 Secret Seashells", checkForSeashellsCode(15), ITEM_TILES[SEASHELL], group="seashells"),
