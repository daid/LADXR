...
ITEM_TILES = {
    ...
    OCARINA: TileInfo(0x90, shift4=True),
    FEATHER: TileInfo(0x92, shift4=True),
...
BINGO_GOALS = [
    ...
    Goal("Find the {INSTRUMENT5}", checkMemoryMask("$DB6A", "2"), TileInfo(0x1510, colormap=[2, 3, 1, 0])),
    Goal("Find the {INSTRUMENT6}", checkMemoryMask("$DB6B", "2"), TileInfo(0x1514, colormap=[2, 3, 1, 0])),
    Goal("Find the {INSTRUMENT7}", checkMemoryMask("$DB6C", "2"), TileInfo(0x1518, colormap=[2, 3, 1, 0])),
    Goal("Find the {INSTRUMENT8}", checkMemoryMask("$DB6D", "2"), TileInfo(0x151C, colormap=[2, 3, 1, 0])),
    ...
    Goal("Do the Raft Minigame", checkMemoryMask("$D84C", "$80"), TileInfo(0x087C, flipH=True, colormap=[2, 3, 1, 0])),
