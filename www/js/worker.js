...
self.onmessage = async (event) => {
    ...
    try {
        ...
        self.postMessage({type: "done", id: event.data.id, success: true, seed: seed, romFilename: "LADXR_" + seed + ".gbc", rom: pyodide.FS.readFile("/output.gbc"), spoiler: pyodide.FS.readFile("/spoiler.txt", {"encoding": "utf8"})});
    } catch (error) {
