...
$options = [
    'Main' => [
        ...
        'race' => ['label' => 'Race mode', 'type' => 'check', 'default' => false, 'arg' => '--race',
    ...
    'Gameplay' => [
        'keysanity' => ['label' => 'Keysanity', 'type' => 'check', 'default' => '', 'arg' => '--keysanity',
            'tooltip' => 'If enabled, fungeon keys, maps and compasses can be found anywhere. Else they will only be in their respective dungeon.'],
        ...
        'hpmode' => ['label' => 'Health mode', 'type' => ['default' => 'Normal', 'inverted' => 'Inverted', '1' => 'Start with 1 heart'], 'arg' => '--hpmode', 'default' => 'default',
            'tooltip' => '[Normal] health works as you would expect.|[Inverted] you start with 9 heart containers, but killing a boss will take a heartcontainer instead of giving one.|[Start with 1] normal game, you just start with 1 hearth instead of 3.'],
        'hardmode' => ['label' => 'Enable oracle mode', 'type' => 'check', 'default' => false, 'arg' => '--hard-mode',
    ...
    'User options' => [
        ...
        'no-flash' => ['label' => 'Remove flashing lights', 'type' => 'check', 'default' => true, 'arg' => '--remove-flashing-lights',
