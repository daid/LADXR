...
$options = [
    ...
    'Items' => [
        'heartpiece' => ['label' => 'Randomize heart pieces', 'type' => 'check', 'default' => '1', 'arg' => '--heartpiece',
            'tooltip' => 'Includes heart pieces in the item pool'],
        'seashells' => ['label' => 'Randomize hidden seashells', 'type' => 'check', 'default' => '1', 'arg' => '--seashells',
            'tooltip' => 'Randomizes the secret sea shells hiding in the ground/trees. (chest are always randomized)'],
        'heartcontainers' => ['label' => 'Randomize heart containers', 'type' => 'check', 'default' => '1', 'arg' => '--heartcontainers',
    ...
    'Gameplay' => [
        'dungeonitems' => ['label' => 'Dungeon items', 'type' => ['standard' => 'Standard', 'smallkeys' => 'Small keys', 'localkeys' => 'Map/Compass/Beaks', 'localnightmarekey' => 'MCB + SmallKeys', 'keysanity' => 'Keysanity', 'keysy' =>' Keysy'], 'default' => 'standard', 'arg' => '--dungeon-items',
        ...
        'goal' => ['label' => 'Goal', 'type' => ['8' => '8 instruments', '7' => '7 instruments', '6' => '6 instruments', '5' => '5 instruments', '4' => '4 instruments', '3' => '3 instruments', '2' => '2 instruments', '1' => '1 instrument', '0' => 'No instruments', 'open' => 'Egg already open', 'random' => 'Random instrument count', 'open-4' => 'Random short game (0-4)', '5-8' => 'Random long game (5-8)', 'seashells' => 'Seashell hunt (20)', 'bingo' => 'Bingo!', 'bingo-full' => 'Bingo-25!'], 'default' => '8', 'arg' => '--goal',
            'tooltip' => 'Changes the goal of the game.|[1-8 instruments], number of instruments required to open the egg.|[No instruments] open the egg without instruments, still requires the ocarina with the balled of the windfish|[Egg already open] the egg is already open, just head for it once you have the items needed to defeat the boss.|[Randomized instrument count] random number of instruments required to open the egg, between 0 and 8.|[Random short/long game] random number of instruments required to open the egg, chosen between 0-4 and 5-8 respectively.|[Seashell hunt] egg will open once you collected 20 seashells. Instruments are replaced by seashells and shuffled.|[Bingo] Generate a 5x5 bingo board with various goals. Complete one row/column or diagonal to win![Bingo-25] Bingo, but need to fill the whole bingo card to win!'],
        'pool' => ['label' => 'Item pool', 'type' => ['' => 'Normal', 'casual' => 'Casual', 'pain' => 'Path of Pain', 'keyup' => 'More keys'], 'arg' => '--pool', 'default' => '',
            'tooltip' => 'Effects which items are shuffled.|[Casual] places more inventory and key items so the seed is easier.|[More keys] adds more small keys and extra nightmare keys so dungeons are easier.|[Path of pain]... just find out yourself.'],
        'hpmode' => ['label' => 'Health mode', 'type' => ['default' => 'Normal', 'inverted' => 'Inverted', '1' => 'Start with 1 heart', 'low' => 'Low max'], 'arg' => '--hpmode', 'default' => 'default',
            'tooltip' => '[Normal] health works as you would expect.|[Inverted] you start with 9 heart containers, but killing a boss will take a heartcontainer instead of giving one.|[Start with 1] normal game, you just start with 1 heart instead of 3.|[Low max] replace heart containers with heart pieces.'],
        'hardmode' => ['label' => 'Hard mode', 'type' => ['none' => 'Disabled', 'oracle' => 'Oracle', 'hero' => 'Hero', 'ohko' => 'One hit KO'], 'default' => 'Disabled', 'arg' => '--hard-mode',
            'tooltip' => '[Oracle] Less iframes and heath from drops. Bombs damage yourself. Water damages you without flippers. No piece of power or acorn.|[Hero] Switch version hero mode, double damage, no heart/fairy drops.|[One hit KO] You die on a single hit, always.'],
