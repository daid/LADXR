...
$options = [
    ...
    'heartcontainers' => ['label' => 'Randomize heart containers', 'type' => 'check', 'default' => 'true', 'arg' => '--heartcontainers', 'tooltip' => 'Includes boss heart container drops in the item pool'],
    ...
    'miniboss' => ['label' => 'Miniboss shuffle', 'type' => ['default' => 'Normal', 'shuffle' => 'Shuffle', 'random' => 'Randomize'], 'arg' => '--miniboss', 'tooltip' => 'Randomizes the dungeon minibosses that each dungeon has'],
    'boomerang' => ['label' => 'Boomerang trade', 'type' => ['default' => 'Normal (require magnifier for boomerang)', 'trade' => 'Trade: Trade is always available, boomerang is shuffled in pool', 'gift' => 'Gift: Boomerang trade guy gives you a gift, boomerang itself is shuffled in the item pool'], 'default' => 'gift', 'arg' => '--boomerang'],
    ...
    'logic' => ['label' => 'Logic', 'type' => ['casual' => 'Casual', '' => 'Normal', 'hard' => 'Hard', 'glitched' => 'Glitched'], 'arg' => '--logic', 'tooltip' => 'Affects where items are allowed to be placed.  See the main site linked above for details.'],
    'goal' => ['label' => 'Goal of the game', 'type' => ['8' => '8 instruments', '7' => '7 instruments', '6' => '6 instruments', '5' => '5 instruments', '4' => '4 instruments', '3' => '3 instruments', '2' => '2 instruments', '1' => '1 instrument', '0' => 'No instruments (only Marins song)', '-1' => 'Egg already open', 'random' => 'Random instrument count', 'seashells' => 'Seashell hunt (20)'], 'default' => '8', 'arg' => '--goal'],
    ...
    'no-flash' => ['label' => 'Remove flashing lights', 'type' => 'check', 'default' => true, 'arg' => '--remove-flashing-lights', 'tooltip' => 'Remove the flashing light effects from Mamu, shopkeeper and MadBatter. Useful for capture cards and people that are sensitive for these things.', 'aesthetic' => True],
