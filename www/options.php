...
$options = [
    ...
    'Gameplay' => [
        ...
        'goal' => ['label' => 'Goal', 'type' => ['8' => '8 instruments', '7' => '7 instruments', '6' => '6 instruments', '5' => '5 instruments', '4' => '4 instruments', '3' => '3 instruments', '2' => '2 instruments', '1' => '1 instrument', '0' => 'No instruments', 'open' => 'Egg already open', 'random' => 'Random instrument count', 'open-4' => 'Random short game (0-4)', '5-8' => 'Random long game (5-8)', 'seashells' => 'Seashell hunt (20)', 'bingo' => 'Bingo!'], 'default' => '8', 'arg' => '--goal',
            'tooltip' => 'Changes the goal of the game.|[1-8 instruments], number of instruments required to open the egg.|[No instruments] open the egg without instruments, still requires the ocarina with the balled of the windfish|[Egg already open] the egg is already open, just head for it once you have the items needed to defeat the boss.|[Randomized instrument count] random number of instruments required to open the egg, between 0 and 8.|[Random short/long game] random number of instruments required to open the egg, chosen between 0-4 and 5-8 respectively.|[Seashell hunt] egg will open once you collected 20 seashells. Instruments are replaced by seashells and shuffled.|[Bingo] Generate a 5x5 bingo board with various goals. Complete one row/column or diagonal to win!'],
